...
class SoundGenerator:
    def __init__(self, model_name, hop_length, n_fft, win_size):
    ...
    def generate_Song(self, song_order=None):
...
if __name__ == "__main__":
    ...
    sound_generator = SoundGenerator("VAE_2D_1.0_24_2500samples", HOP_LENGTH, N_FFT, WIN_LENGTH)
    sound_generator.sub_folder = "1.0_24"
